/** Ch 4 Enzymes — flashcard deck (34 cards) */
...
export const FLASHCARD_DECK = [
  ...
  // Subtopic 2: Enzyme Mechanism
  {
    ...
    front: "What is the <strong>active site</strong> (活性位點)?",
    back: "The <strong>specific region</strong> on an enzyme where the <strong>substrate</strong> binds.",
  },
  {
    id: 8,
    subtopic: "Enzyme Mechanism",
    front: "What is a <strong>substrate</strong> (底物)?",
    back: "The molecule that <strong>binds to the active site</strong> and is converted into product(s).",
  },
  {
    id: 9,
    subtopic: "Enzyme Mechanism",
    front: "What is the <strong>enzyme-substrate complex</strong> (酶-底物複合物)?",
    back: "Forms when substrate binds the active site; it <strong>lowers activation energy</strong> so the reaction proceeds.",
  },
  {
    id: 10,
    subtopic: "Enzyme Mechanism",
  ...
  // Subtopic 6: Denaturation
  {
    ...
    front: "What is <strong>denaturation</strong> (變性)?",
    back: "<strong>Irreversible</strong> loss of the enzyme's <strong>specific 3D structure</strong> (especially the active site).",
  },
  {
    id: 32,
    subtopic: "Denaturation",
