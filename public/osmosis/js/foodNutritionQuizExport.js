...
export function downloadWord(questions, answersMode, lang) {
  ...
  const titleEn = answersMode
    ? "Ch 5 Food & Nutrition — Answers"
    : "Ch 5 Food & Nutrition — Questions";
  const titleZh = answersMode ? "第五章 食物與營養 — 答案" : "第五章 食物與營養 — 試題";
  ...
  a.download = (answersMode ? "food_nutrition_answers_" : "food_nutrition_questions_") + ts + ".doc";
  a.click();
