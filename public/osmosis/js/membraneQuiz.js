import { MEMBRANE_QUIZ, QUIZ_SECTIONS } from "./membraneQuizData.js";
...
const UI = {
  en: {
    ...
    revBandFair: "Mixed performance: re-read membrane notes for weaker topics, then regenerate.",
    revBandLow:
      "Several concepts need consolidation. Review fluid mosaic, permeability, osmosis, and active transport before the next round.",
...
export function initMembraneQuiz() {
...
document.addEventListener("DOMContentLoaded", () => initMembraneQuiz());
