...
const WORKSHEET_PHRASE_MAP = {
    ...
    'Generated by S3 Biology': {
        'zh-Hant': '由 S3 Biology 生成',
        fr: 'Genere par S3 Biology',
        ru: 'Сгенерировано в S3 Biology',
        fa: 'تولید شده توسط S3 Biology',
        ur: 'S3 Biology کی جانب سے تیار کردہ',
        tl: 'Nabuo ng S3 Biology'
    }
};
...
function renderWorksheet(worksheet, mode) {
    ...
    html += `
            <div class="worksheet-footer">
                <span>${tr('Generated by S3 Biology', '由 S3 Biology 生成')}</span>
            </div>
        </div>
    `;
...
function exportToPDF() {
    ...
    const title = tr('S3 Biology — Balancing Chemical Equations Worksheet', 'S3 Biology — 化学方程式配平练习');
        ...
        <tbody>
            <tr>
                <td class="print-content">
                    ...
                    <div class="doc-footer">Generated by S3 Biology</div>
